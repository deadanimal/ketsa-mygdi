...
function SortableComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragover", function SortableComponent_div_1_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r475); const ctx_r474 = ɵngcc0.ɵɵnextContext(); return ctx_r474.onItemDragover($event, 0); })("dragenter", function SortableComponent_div_1_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r475); const ctx_r476 = ɵngcc0.ɵɵnextContext(); return ctx_r476.cancelEvent($event); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r470 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ctx_r470.placeholderClass)("ngStyle", ctx_r470.placeholderStyle);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r470.placeholderItem);
} }
...
function SortableComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragstart", function SortableComponent_div_2_Template_div_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r481); const item_r477 = ctx.$implicit; const i_r478 = ctx.index; const ctx_r480 = ɵngcc0.ɵɵnextContext(); return ctx_r480.onItemDragstart($event, item_r477, i_r478); })("dragend", function SortableComponent_div_2_Template_div_dragend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r481); const ctx_r482 = ɵngcc0.ɵɵnextContext(); return ctx_r482.resetActiveItem($event); })("dragover", function SortableComponent_div_2_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r481); const i_r478 = ctx.index; const ctx_r483 = ɵngcc0.ɵɵnextContext(); return ctx_r483.onItemDragover($event, i_r478); })("dragenter", function SortableComponent_div_2_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r481); const ctx_r484 = ɵngcc0.ɵɵnextContext(); return ctx_r484.cancelEvent($event); });
    ɵngcc0.ɵɵtemplate(1, SortableComponent_div_2_ng_template_1_Template, 0, 0, "ng-template", 6);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const item_r477 = ctx.$implicit;
    const i_r478 = ctx.index;
    const ctx_r471 = ɵngcc0.ɵɵnextContext();
    const _r472 = ɵngcc0.ɵɵreference(4);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(5, _c0, ctx_r471.itemClass, i_r478 === ctx_r471.activeItem ? ctx_r471.itemActiveClass : ""))("ngStyle", ctx_r471.getItemStyle(i_r478 === ctx_r471.activeItem));
    ɵngcc0.ɵɵattribute("aria-grabbed", i_r478 === ctx_r471.activeItem);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r471.itemTemplate || _r472)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(8, _c1, item_r477, i_r478));
} }
function SortableComponent_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵtext(0);
} if (rf & 2) {
    const item_r485 = ctx.item;
    ɵngcc0.ɵɵtextInterpolate(item_r485.value);
} }
