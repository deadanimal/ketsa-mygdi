...
@Component({
  selector: 'app-management-acceptuser',
  templateUrl: './management-acceptuser.component.html',
  styleUrls: ['./management-acceptuser.component.scss']
})
export class ManagementAcceptuserComponent implements OnInit, OnDestroy {
  ...
  deleteUser() {
    swal.fire({
      title: "Pengesahan",
      text: "Anda pasti untuk MENOLAK pemohonan pengguna ini?",
      type: "warning",
      buttonsStyling: false,
      confirmButtonClass: "btn btn-info",
      confirmButtonText: "Pasti",
  ...
  acceptUser() {
    swal.fire({
      title: "Pengesahan",
      text: "Anda pasti untuk MENERIMA pemohonan pengguna ini?",
      type: "warning",
      buttonsStyling: false,
      confirmButtonClass: "btn btn-info",
      confirmButtonText: "Pasti",
