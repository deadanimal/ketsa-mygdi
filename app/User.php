...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name','email','password','nric','agensi_organisasi','bahagian','sektor','phone_pejabat','surat_sokongan','alamat','status','disahkan','institusi','kategori','assigned_roles','mygdix_user_id','postcode','city','state','country'
    ];
