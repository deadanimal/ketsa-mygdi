                        ...
                        <form method="post" class="form-horizontal" action="{{url('simpan_kemaskini_profil')}}" id="form_kemaskini_profil" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-8">
                                            @if(auth::user()->hasRole(['Pentadbir Aplikasi','Super Admin']))
                                                <select class="form-control form-control-sm ml-3" id="peranan" name="peranan[]" multiple>
                                                  <?php
                                                  if(!empty($roles)){
                                                    foreach($roles as $role){
                                                      ...
                                                      if(!empty($user->getRoleNames())){
                                                        ...
                                                        if($assigned == 0){
                                                          ?><option value="{{ $role->name }}" selected>{{ $role->name }}</option><?php
                                                        }else{
                                                          ?><option value="{{ $role->name }}">{{ $role->name }}</option><?php
                                                        }
                                                      }else{
                                                        ?><option value="{{ $role->name }}">{{ $role->name }}</option><?php
                                                      }
                                ...
                                <div class="pl-lg-4">
                                    <div class="row mb-2">
                                        <div class="col-3">
                                            <image id="profileImage" src="" style="border-radius: .95rem" width='250px'/>
                                        </div>
