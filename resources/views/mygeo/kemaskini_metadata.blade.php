...
@section('content')
  ...
  <form method="post" class="form-horizontal" action="{{url('simpan_kemaskini_metadata')}}" enctype="multipart/form-data">

        @if(auth::user()->hasRole(['Pengesah Metadata','Super Admin']))
            @include('mygeo.modal_catatan')
        @endif 
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-12">
            <div class="card">
              @csrf
              <input type="hidden" name="metadata_type" value="{{ $metadata_type }}">
              <input type="hidden" name="metadata_id" value="{{ $metadata_id }}">
              <div class="card-body">
                  <div class="clearfix">
                        <p id="lbl_kategori">Kategori : &nbsp;&nbsp;&nbsp;</p>
                ...
                <div id="accordion">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <input type="hidden" name="publisher_name" value="{{ $name }}">
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <input type="hidden" name="publisher_agensi_organisasi" value="{{ $org }}">
                                </td>
                              </tr>
                              <tr>
                                <td>Email&nbsp;</td>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <input type="hidden" name="publisher_email" value="{{ $mail }}">
                                </td>
                              </tr>
                              <tr>
                                <td>Telephone&nbsp;</td>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <input type="hidden" name="publisher_phone" value="{{ $tel }}">
                                </td>
                              </tr>
                            </tbody>
                          </table>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                    ...
                                    ?><input type="hidden" name="c2_contact_name" id="c2_contact_name" value="{{ $pengesahs->agensi_organisasi }}">
                                </td>
                              </tr>
                              <tr>
                                <td>Agency/Organization &nbsp;</td>
                                <td>:&nbsp;&nbsp;&nbsp;</td>
                                <td>
                                  <input type="text" name="c2_contact_agensiorganisasi" id="c2_contact_agensiorganisasi" class="form-control" value="{{ $pengesahs->agensi_organisasi }}" readonly>
                                </td>
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td>
                                  <input type="text" name="c2_contact_address1" id="c2_contact_address1" class="form-control" value="{{ $pengesahs->alamat }}" readonly><br>
                              ...
                              <tr>
                                ...
                                <td>:&nbsp;&nbsp;&nbsp;</td>
                                <td>
                                  <input type="email" name="c2_contact_email" id="c2_contact_email" class="form-control" value="{{ $pengesahs->email }}" readonly>
                                </td>
                              </tr>
                              <tr>
                                <td>Fax: &nbsp;</td>
                              ...
                              <tr>
                                ...
                                <td>:&nbsp;&nbsp;&nbsp;</td>
                                <td>
                                  <input type="text" name="c2_contact_phone_office" id="c2_contact_phone_office" class="form-control" value="{{ $pengesahs->phone_pejabat }}" readonly>
                                </td>
                              </tr>
                              <tr>
                                <td>Website: &nbsp;</td>
                  ...
                  <input type="submit" name="btn_save" value="Simpan" class="btn btn-success">
                </div>
              </div>
            </div>
          </div>
