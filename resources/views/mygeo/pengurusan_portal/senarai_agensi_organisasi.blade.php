                    ...
                    <div class="card">
                                ...
                                <div class="col-4 text-right">
                                    <div class="btn-group btn-group-sm" role="group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="btnGroupDrop1">
                                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal_tambah_agensi_organisasi">Agensi / Organisasi /
                                                Institusi +</a>
                        ...
                        <div class="card-body">
                            <div style="overflow-x:auto;">
                                <table id="table_agensi_organisasi" class="table table-bordered table-striped table-sm" style="width:100%;">
                                    <thead>
                                        <tr>
                                            <th>BIL</th>
                                            <th>SEKTOR</th>
