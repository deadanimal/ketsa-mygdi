                            ...
                            <div class="card-body py-4 px-">
                                ...
                                <ul align="justify">
                                    ...
                                    <li>Kami mengalu-alukan kerjasama dari pihak YBhg. Dato'/ Datin/Prof./Dr./Tuan/Puan
                                        ...
                                        soal selidik ini dan diharapkan dapat membantu memperbaiki dan menambahbaik
                                        kualiti perkongsian data yang
                                        diberikan.</li>
                                </ul>
                                ...
                                <div class="px-2">
                                    ...
                                    <div class="row pl-lg-5 mb-4">
                                        <div class="col-xl-12">
                                            <div class=" custom-control custom-radio mb-2">
                                                <input class=" custom-control-input" id="radioCheck1" name="custom-radio-3"
                                                    type="radio" />
                                            ...
                                            <div class=" custom-control custom-radio mb-2">
                                                <input class=" custom-control-input" id="radioCheck2" name="custom-radio-3"
                                                    type="radio" />
                                            ...
                                            <div class=" custom-control custom-radio mb-2">
                                                <input class="custom-control-input" id="radioCheck3" name="custom-radio-3"
                                                    type="radio" />
                                    ...
                                    <div class="row pl-lg-2 mb-4">
                                        <div class="col-xl-4">
                                            <div class=" custom-control custom-radio mb-2">
                                                <input [(ngModel)]="checkOther" class=" custom-control-input"
                                                    id="radioCheck21" name="custom-radio-2" type="radio" value="1" />
                                            ...
                                            <div class=" custom-control custom-radio mb-2">
                                                <input [(ngModel)]="checkOther" class=" custom-control-input"
                                                    id="radioCheck22" name="custom-radio-2" type="radio" value="2" />
                                        ...
                                        <div class="col-xl-4">
                                            <div class=" custom-control custom-radio mb-2">
                                                <input [(ngModel)]="checkOther" class=" custom-control-input"
                                                    id="radioCheck23" name="custom-radio-2" type="radio" value="3" />
                                            ...
                                            <div class=" custom-control custom-radio mb-2">
                                                <input [(ngModel)]="checkOther" class=" custom-control-input"
                                                    id="radioCheck24" name="custom-radio-2" type="radio" value="4" />
                                            ...
                                            <table>
                                                <tr class="bg-light">
                                                    <th class="text-center" colspan="2" rowspan="2">Pengurusan
                                                        Perkongsian Data Geospatial</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Kawalan keselamatan terhadap proses serahan data yang
                                                        dipraktikkan adalah memadai (encryption
                                                        data, password)</td>
                                ...
                                <div class="px-2">
                                                ...
                                                <div class="col-xl-3">
                                                    <div class="custom-control custom-radio mb-2">
                                                        <input class=" custom-control-input" type="radio" id="choice1"
                                                            name="yes2"><label class="custom-control-label" for="choice1">
                                                            Ya
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4">
                                                    <div class="custom-control custom-radio">
                                                        <input class=" custom-control-input" type="radio" id="choice2"
                                                            name="yes2"><label class="custom-control-label" for="choice2">
                                                            Tidak
                                                        </label>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="mb-2">4.&nbsp;&nbsp; Berikut merupakan screenshot
                                        kajian/analisis/laporan yang sedang/telah
                                    ...
                                    <div [formGroup]="myForm">
                                        <div class="container p-0"
                                            ...
                                            <input formControlName="file" id="file" type="file" class="form-control"
                                                accept="image/*" (change)="onFileChange($event)" sytle="border: none;">
                                            <img [src]="imageSrc" *ngIf="imageSrc"
                                                style="max-height: 500px; max-width: 900px" class="p-2" alt="...">
                                        </div>
                                    </div>
