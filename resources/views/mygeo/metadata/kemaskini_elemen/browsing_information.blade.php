        ...
        <div class="card-body">
            ...
            <div class="my-2">
                <div class="row mb-2">
                    ...
                    <div class="col-7">
                        <input type="text" name="c10_file_name" id="c10_file_name" class="form-control form-control-sm ml-3" value="">
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-3 pl-5">
                    ...
                    <div class="col-7">
                        <input type="text" name="c10_file_type" id="c10_file_type" class="form-control form-control-sm ml-3" value="">
                    </div>
                </div>
                <div class="row mb-2 divBrowsingInformationUrl">
                    ...
                    <div class="col-6">
                        <input type="text" name="c10_file_url" class="form-control form-control-sm ml-3 inputBrowsingInformationUrl urlToTest" value="">
                    </div>
                    <div class="col-1">
            ...
            <div class="my-2">
                <div class="row mb-2">
                    ...
                    <div class="col-6">
                        <input type="text" name="c10_keyword" id="c10_keyword" class="form-control form-control-sm ml-3" value="">
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-3 pl-5">
                    ...
                    <div class="col-6">
                        <input type="text" name="c10_additional_keyword[]" class="form-control form-control-sm ml-3" value="">
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-3 pl-5">
