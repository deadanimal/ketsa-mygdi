                    ...
                    <div class="row sortIt">
                        <div class="col-xl-6">
                            <div class="form-inline ml-3">
                                ...
                                <input class="form-control form-control-sm sortable" type="number" style="width :100px" placeholder="0.0" name="c4_scan_res" id="c4_scan_res" value="{{old('c4_scan_res')}}">
                    ...
                    <div class="row sortIt">
                        <div class="col-xl-6">
                            <div class="form-inline">
                                ...
                                <input class="form-control form-control-sm sortable" type="number" style="width :100px" placeholder="0.0" name="c4_ground_scan" id="c4_ground_scan" value="{{old('c4_ground_scan')}}">
                                <div class="form-control-label ml-2">
                                    meter
                                </div>
                            </div>
