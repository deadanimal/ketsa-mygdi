            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="form-inline ml-3">
                        ...
                        <input class="form-control form-control-sm" type="number" style="width :100px" name="c4_scan_res" id="c4_scan_res" value="">
                ...
                <div class="col-xl-6">
                    <div class="form-inline">
                        ...
                        <input class="form-control form-control-sm" type="number" style="width :100px" name="c4_ground_scan" id="c4_ground_scan" value="">
                        <div class="form-control-label ml-2">
                            meter
                        </div>
                    </div>
