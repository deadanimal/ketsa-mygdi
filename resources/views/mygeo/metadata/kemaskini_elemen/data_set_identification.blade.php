    ...
    <div id="collapse12" class="panel-collapse collapse in" data-parent="#div_c12">
        <div class="card-body">
            <div class="sortableContainer1">
                ...
                <div class="row sortIt">
                    <div class="col-xl-6">
                        <div class="form-inline">
                            <label class="form-control-label mr-3" for="input-dataset-type" data-toggle="tooltip" title="Jenis maklumat geospatial">
                                <?php echo __('lang.spatial_data_set_type'); ?>
                            </label>
                            <select class="form-control form-control-sm sortable" id="c12_dataset_type" name="c12_dataset_type">
                    ...
                    <div class="col-xl-6">
                        <div class="form-inline">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control form-control-sm sortable" name="c12_image_res" id="c12_image_res" placeholder="10.5" value="{{old('c12_image_res')}}">
                ...
                <div class="row sortIt">
                    <div class="col-xl-6">
                        <div class="form-inline">
                            ...
                            <select class="form-control form-control-sm sortable" name="c12_language" id="c12_language">
                                <option selected disabled>Pilih...</option>
                ...
                <div class="row sortIt divMaintenanceInfo">
                    <div class="col-xl-6">
                        <div class="form-inline">
                            <label class="form-control-label mr-3" for="input-hardsoftcopy">
                                <?php echo __('lang.maintenance_and_update'); ?>
                            </label>
                            <select class="form-control form-control-sm sortable" name="c12_maintenanceUpdate" id="c12_maintenanceUpdate">
