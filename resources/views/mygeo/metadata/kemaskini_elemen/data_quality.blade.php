                ...
                <div class="row mb-2">
                    ...
                    <div class="col-xl-3">
                        <select name="c15_data_quality_info" id="c15_data_quality_info" class="form-control form-control-sm">
                            ...
                            <option value="Collection Session">Collection Session</option>
                            <option value="Dataset">Dataset</option>
                            <option value="Series">Series</option>
                            <option value="Feature">Feature</option>
                            <option value="Dimension Group">Dimension Group</option>
                            <option value="Feature Type">Feature Type</option>
                            <option value="Field Session">Field Session</option>
                            <option value="Model">Model</option>
                            <option value="Non Geographic Date Set">Non Geographic Date Set</option>
                    ...
                    <div class="col-md-2">
                        <input class="form-control form-control-sm" type="text" name="c15_data_history" id="c15_data_history" value="">
                    </div>
                    <div class="col-xl-1">
                    ...
                    <div class="col-xl-3">
                        <input class="form-control form-control-sm" type="date" name="c15_date" id="c15_date" value="">
                    </div>
                </div>
            </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="Completeness_Commission">
                                                        <td>
                                                            <label class="form-check-label" for="c3_3">
                                                                ...
                                                                <input type="text" name="c15_t1_comply_level" id="c15_t1_comply_level" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class="Completeness_Commission">
                                                        <td>
                                                            <label class="form-check-label" for="c15_t1_commission_date">
                                                                ...
                                                                <div class="input-group date" id="c15_t1_commission_date_div" data-target-input="nearest">
                                                                    <input type="date" name="c15_t1_date" id="c15_t1_date" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class="Completeness_Commission">
                                                        <td>
                                                            <label class="form-check-label" for="c3_4">
                                                                ...
                                                                <input type="text" name="c15_t1_conform_result" id="c15_t1_conform_result" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <?php //================= ?>
                                                    ...
                                                    <tr class="Completeness_Omission">
                                                        <td>
                                                            <label class="form-check-label" for="c3_3">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.compliance_level'); ?> :</b>
                                                                <input type="text" name="c15_t1_comply_level_2" id="c15_t1_comply_level_2" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class="Completeness_Omission">
                                                        <td>
                                                            <label class="form-check-label" for="c15_t1_commission_date">
                                                                <b data-toggle="tooltip" title="Tarikh penilaian kualiti data"><?php echo __('lang.date'); ?> :</b>
                                                                <div class="input-group date" id="c15_t1_commission_date_div" data-target-input="nearest">
                                                                    <input type="date" name="c15_t1_date_2" id="c15_t1_date_2" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class="Completeness_Omission">
                                                        <td>
                                                            <label class="form-check-label" for="c3_4">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.conformance_result'); ?> :</b>
                                                                <input type="text" name="c15_t1_conform_result_2" id="c15_t1_conform_result_2" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t2_type" style="margin-right:50px;">
                                                                <input type="radio" name="c15_t2_type" id='conceptual' value="Conceptual">&nbsp;<?php echo __('lang.conceptual_consistency'); ?>
                                                            </label>
                                                        </td>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t2_type" style="margin-right:50px;">
                                                                <input type="radio" name="c15_t2_type" value="Domain">&nbsp;<?php echo __('lang.domainConsistency'); ?>
                                                            </label>
                                                        </td>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t2_type" style="margin-right:50px;">
                                                                <input type="radio" name="c15_t2_type" value="Format">&nbsp;<?php echo __('lang.formatConsistency'); ?>
                                                            </label>
                                                        </td>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t2_type" style="margin-right:50px;">
                                                                <input type="radio" name="c15_t2_type" value="Topological">&nbsp;<?php echo __('lang.topologicalConsistency'); ?>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <?php //================= ?>
                                                    ...
                                                    <tr class='Conceptual'>
                                                        <td>
                                                            <label class="form-check-label" for="c3_3">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.compliance_level'); ?> :</b>
                                                                <input type="text" name="c15_t2_comply_level" id="c15_t2_comply_level" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class='Conceptual'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t2_date">
                                                                ...
                                                                <div class="input-group date" id="c15_t2_conceptual_date_div" data-target-input="nearest">
                                                                    <input type="date" name="c15_t2_date" id="c15_t2_date" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class='Conceptual'>
                                                        <td>
                                                            <label class="form-check-label" for="c3_4">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.conformance_result'); ?> :</b>
                                                                <input type="text" name="c15_t2_conform_result" id="c15_t2_conform_result" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <?php //================= ?>
                                                    ...
                                                    <tr class='Domain'>
                                                        <td>
                                                            <label class="form-check-label" for="c3_3">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.compliance_level'); ?> :</b>
                                                                <input type="text" name="c15_t2_comply_level_2" id="c15_t2_comply_level_2" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class='Domain'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t2_date_2">
                                                                <b data-toggle="tooltip" title="Tarikh penilaian kualiti data"><?php echo __('lang.date'); ?> :</b>
                                                                <div class="input-group date" id="c15_t2_conceptual_date_div" data-target-input="nearest">
                                                                    <input type="date" name="c15_t2_date_2" id="c15_t2_date_2" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class='Domain'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t2_conform_result_2">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.conformance_result'); ?> :</b>
                                                                <input type="text" name="c15_t2_conform_result_2" id="c15_t2_conform_result_2" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <?php //================= ?>
                                                    ...
                                                    <tr class='Format'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t2_comply_level_3">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.compliance_level'); ?> :</b>
                                                                <input type="text" name="c15_t2_comply_level_3" id="c15_t2_comply_level_3" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class='Format'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t2_date_3">
                                                                <b data-toggle="tooltip" title="Tarikh penilaian kualiti data"><?php echo __('lang.date'); ?> :</b>
                                                                <div class="input-group date" id="c15_t2_conceptual_date_div" data-target-input="nearest">
                                                                    <input type="date" name="c15_t2_date_3" id="c15_t2_date_3" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class='Format'>
                                                        <td>
                                                            <label class="form-check-label" for="c3_4">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.conformance_result'); ?> :</b>
                                                                <input type="text" name="c15_t2_conform_result_3" id="c15_t2_conform_result_3" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <?php //================= ?>
                                                    ...
                                                    <tr class='Topological'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t2_comply_level_4">
                                                                ...
                                                                <input type="text" name="c15_t2_comply_level_4" id="c15_t2_comply_level_4" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class='Topological'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t2_date_4">
                                                                <b data-toggle="tooltip" title="Tarikh penilaian kualiti data"><?php echo __('lang.date'); ?> :</b>
                                                                <div class="input-group date" id="c15_t2_conceptual_date_div" data-target-input="nearest">
                                                                    <input type="date" name="c15_t2_date_4" id="c15_t2_date_4" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class='Topological'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t2_conform_result_4">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.conformance_result'); ?> :</b>
                                                                <input type="text" name="c15_t2_conform_result_4" id="c15_t2_conform_result_4" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                    ...
                                                    <tr class='AbsoluteorExternal'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t3_comply_level">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.compliance_level'); ?> :</b>
                                                                <input type="text" name="c15_t3_comply_level" id="c15_t3_comply_level" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class='AbsoluteorExternal'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t3_date">
                                                                ...
                                                                <div class="input-group date" id="c15_t3_absExt_date_div" data-target-input="nearest">
                                                                    <input type="date" name="c15_t3_date" id="c15_t3_date" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class='AbsoluteorExternal'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t3_conform_result">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.conformance_result'); ?> :</b>
                                                                <input type="text" name="c15_t3_conform_result" id="c15_t3_conform_result" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <?php //================= ?>
                                                    ...
                                                    <tr class='RelativeorInternal'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t3_comply_level_2">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.compliance_level'); ?> :</b>
                                                                <input type="text" name="c15_t3_comply_level_2" id="c15_t3_comply_level_2" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class='RelativeorInternal'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t3_date_2">
                                                                <b data-toggle="tooltip" title="Tarikh penilaian kualiti data"><?php echo __('lang.date'); ?> :</b>
                                                                <div class="input-group date" id="c15_t3_absExt_date_div" data-target-input="nearest">
                                                                    <input type="date" name="c15_t3_date_2" id="c15_t3_date_2" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class='RelativeorInternal'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t3_conform_result_2">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.conformance_result'); ?> :</b>
                                                                <input type="text" name="c15_t3_conform_result_2" id="c15_t3_conform_result_2" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <?php //================= ?>
                                                    ...
                                                    <tr class='GriddedData'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t3_comply_level_3">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.compliance_level'); ?> :</b>
                                                                <input type="text" name="c15_t3_comply_level_3" id="c15_t3_comply_level_3" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class='GriddedData'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t3_date_3">
                                                                <b data-toggle="tooltip" title="Tarikh penilaian kualiti data"><?php echo __('lang.date'); ?> :</b>
                                                                <div class="input-group date" id="c15_t3_absExt_date_div" data-target-input="nearest">
                                                                    <input type="date" name="c15_t3_date_3" id="c15_t3_date_3" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class='GriddedData'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t3_conform_result_3">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.conformance_result'); ?> :</b>
                                                                <input type="text" name="c15_t3_conform_result_3" id="c15_t3_conform_result_3" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                    ...
                                                    <tr class='AccuracyorTimeMeasurement'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t4_comply_level">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.compliance_level'); ?> :</b>
                                                                <input type="text" name="c15_t4_comply_level" id="c15_t4_comply_level" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class='AccuracyorTimeMeasurement'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t4_date">
                                                                ...
                                                                <div class="input-group date" id="c15_t4_accuTimeMeasure_date_div" data-target-input="nearest">
                                                                    <input type="date" name="c15_t4_date" id="c15_t4_date" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class='AccuracyorTimeMeasurement'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t4_conform_result">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.conformance_result'); ?> :</b>
                                                                <input type="text" name="c15_t4_conform_result" id="c15_t4_conform_result" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <?php //================= ?>
                                                    ...
                                                    <tr class='TemporalConsistency'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t4_comply_level_2">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.compliance_level'); ?> :</b>
                                                                <input type="text" name="c15_t4_comply_level_2" id="c15_t4_comply_level_2" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class='TemporalConsistency'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t4_date_2">
                                                                <b data-toggle="tooltip" title="Tarikh penilaian kualiti data"><?php echo __('lang.date'); ?> :</b>
                                                                <div class="input-group date" id="c15_t4_accuTimeMeasure_date_div" data-target-input="nearest">
                                                                    <input type="date" name="c15_t4_date_2" id="c15_t4_date_2" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class='TemporalConsistency'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t4_conform_result_2">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.conformance_result'); ?> :</b>
                                                                <input type="text" name="c15_t4_conform_result_2" id="c15_t4_conform_result_2" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <?php //================= ?>
                                                    ...
                                                    <tr class='TemporalValidity'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t4_comply_level_3">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.compliance_level'); ?> :</b>
                                                                <input type="text" name="c15_t4_comply_level_3" id="c15_t4_comply_level_3" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class='TemporalValidity'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t4_date_3">
                                                                <b data-toggle="tooltip" title="Tarikh penilaian kualiti data"><?php echo __('lang.date'); ?> :</b>
                                                                <div class="input-group date" id="c15_t4_accuTimeMeasure_date_div" data-target-input="nearest">
                                                                    <input type="date" name="c15_t4_comply_level_3" id="c15_t4_date_3" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class='TemporalValidity'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t4_conform_result_3">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.conformance_result'); ?> :</b>
                                                                <input type="text" name="c15_t4_conform_result_3" id="c15_t4_conform_result_3" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class='classificationCorrectness'>
                                                        <td>
                                                            <label class="form-check-label" for="c3_3">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.compliance_level'); ?> :</b>
                                                                <input type="text" name="c15_t5_comply_level" id="c15_t5_comply_level" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class='classificationCorrectness'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t5_classCorrect_date">
                                                                ...
                                                                <div class="input-group date" id="c15_t5_classCorrect_date_div" data-target-input="nearest">
                                                                    <input type="date" name="c15_t5_date" id="c15_t5_date" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class='classificationCorrectness'>
                                                        <td>
                                                            <label class="form-check-label" for="c3_4">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.conformance_result'); ?> :</b>
                                                                <input type="text" name="c15_t5_conform_result" id="c15_t5_conform_result" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <?php //================= ?>
                                                    ...
                                                    <tr class='nonQuantitativeAttributeCorrectness'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t5_comply_level_2">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.compliance_level'); ?> :</b>
                                                                <input type="text" name="c15_t5_comply_level_2" id="c15_t5_comply_level_2" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class='nonQuantitativeAttributeCorrectness'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t5_classCorrect_2_date">
                                                                ...
                                                                <div class="input-group date" id="c15_t5_classCorrect_2_date_div" data-target-input="nearest">
                                                                    <input type="date" name="c15_t5_date_2" id="c15_t5_date_2" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class='nonQuantitativeAttributeCorrectness'>
                                                        <td>
                                                            <label class="form-check-label" for="c3_4">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.conformance_result'); ?> :</b>
                                                                <input type="text" name="c15_t5_conform_result_2" id="c15_t5_conform_result_2" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <?php //================= ?>
                                                    ...
                                                    <tr class='quantitativeAttributeCorrectness'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t5_comply_level_3">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.compliance_level'); ?> :</b>
                                                                <input type="text" name="c15_t5_comply_level_3" id="c15_t5_comply_level_3" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr class='quantitativeAttributeCorrectness'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t5_classCorrect_date_3">
                                                                ...
                                                                <div class="input-group date" id="c15_t5_classCorrect_date_div_3" data-target-input="nearest">
                                                                    <input type="date" name="c15_t5_date_3" id="c15_t5_date_3" class="form-control form-control-sm" value="">
                                                                </div>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class='quantitativeAttributeCorrectness'>
                                                        <td>
                                                            <label class="form-check-label" for="c15_t5_conform_result_3">
                                                                <b data-toggle="tooltip" title="Pengisian ketekalan konsep berdasarkan tahap pematuhan."><?php echo __('lang.conformance_result'); ?> :</b>
                                                                <input type="text" name="c15_t5_conform_result_3" id="c15_t5_conform_result_3" class="form-control form-control-sm" value="">
                                                            </label>
                                                        </td>
                                                    </tr>
                                                </tbody>
