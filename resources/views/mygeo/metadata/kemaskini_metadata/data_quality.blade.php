                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <input type="text" name="c15_data_history" id="c15_data_history" style="max-width: 100%;" class="form-control col-lg-2" value="{{ $dataHist }}">
                                </td>
                                <td>&nbsp;Date</td>
                                <td>&nbsp;:</td>
                                <td>
                                    ...
                                    ?>
                                    <input type="date" name="c15_date" id="c15_date" class="form-control" value="{{ $dqDate }}">
                                </td>
                            </tr>
                        </tbody>
                    </table>
