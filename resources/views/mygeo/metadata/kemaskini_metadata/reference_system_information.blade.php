            ...
            foreach($template->template[strtolower($catSelected)]['accordion13'] as $key=>$val){
                if($val['status'] == "customInput"){
                    ...
                    <div class="row mb-2 sortIt">
                        ...
                        <div class="col-8">
                            <input class="form-control form-control-sm ml-3 sortable" type="text" name="{{ $key }}" data-status="<?php echo $val['status']; ?>" value="{{ (isset($metadataxml->customInputs->accordion13->$key) ? $metadataxml->customInputs->accordion13->$key:"") }}"/>
                        </div>
                    </div>
                    <?php
                }
                    ...
                    <table>
                        ...
                        foreach($template->template[strtolower($catSelected)]['accordion13'] as $key=>$val){
                            ...
                            if($key == "refsys_projection"){
                                ...
                                ?>
                                <label class="form-control-label mr-4" style="margin-left:20px;" <?php if($val['status'] == "inactive"){ ?>style="display:none;"<?php } ?>>
