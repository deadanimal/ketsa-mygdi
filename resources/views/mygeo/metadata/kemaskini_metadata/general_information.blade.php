            ...
            foreach($template->template[strtolower($catSelected)]['accordion1'] as $key=>$val){
                if($val['status'] == "customInput"){
                    ...
                    <div class="row mb-2 sortIt">
                        ...
                        <div class="col-8">
                            <input class="form-control form-control-sm ml-3 sortable" type="text" name="{{ $key }}" data-status="<?php echo $val['status']; ?>" value="{{ (isset($metadataxml->customInputs->accordion1->$key) ? $metadataxml->customInputs->accordion1->$key:"") }}"/>
                        </div>
                    </div>
                    <?php
                }
