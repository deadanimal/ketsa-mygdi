...
?>
    ...
    $('#c15_date_div,#c15_t1_commission_date_div,#c15_t2_conceptual_date_div,#c15_t3_absExt_date_div,#c15_t4_accuTimeMeasure_date_div,c15_t5_classCorrect_date_div')
            .datetimepicker({
            format: 'DD/MM/YYYY',
                    format: 'L'
            });
...
?>
    ...
    var type = $(this).val();
    if (type == "Application") {
    $('#c2_abstract').attr('placeholder',
            'Nama Aplikasi – Tujuan – Tahun Pembangunan – Kemaskini – Data Terlibat – Sasaran Pengguna – Versi – Perisian Yang Digunakan Dalam Pembangunan'
            );
    ...
    $('#c2_abstract').attr('placeholder',
            'Nama Peta – Kawasan - Tujuan – Tahun Terbitan – Edisi – No. Siri – Skala – Unit '
            );
    } else if (type == "Raster Data") {
    $('#c2_abstract').attr('placeholder',
            'Nama Data - Lokasi - Rumusan Tentang Data - Tujuan Data - Kaedah Penyediaan Data – Format - Unit – Skala - Status Data - Tahun Perolehan - Jenis Satelit – Format – Resolusi - Kawasan Litupan'
            );
    } else if (type == "Services") {
    $('#c2_abstract').attr('placeholder',
            'Nama Servis – Lokasi – Tujuan – Data Yang Terlibat – Polisi –Peringkat Capaian- Format'
            );
    } else if (type == "Software") {
    $('#c2_abstract').attr('placeholder',
            'Nama Perisian – Versi- Tujuan – Tahun Penggunaan Perisian – Kaedah Perolehan – Format – Pengeluar – Keupayaan -Data Yang Terlibat –Keperluan Perkakasan'
            );
    } else if (type == "Vector Data") {
    $('#c2_abstract').attr('placeholder',
            'Nama Data - Lokasi - Rumusan Tentang Data - Tujuan Data - Kaedah Penyediaan Data – Format - Unit – Skala - Status Data'
            );
    }
    });
<?php
...
<script>
    ...
    var sbltValue = document.getElementById("sblt").value;
    var eblgValue = document.getElementById("eblg").value;
    var data = ["North Bound Latitude: " + nbltValue, "West Bound Longitude: " + wblgValue,
            "South Bound Latitude: " + sbltValue, "East Bound Longitude: " + eblgValue
    ];
    alert(data);
    }
</script>
