                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="table_newUsers" class="table table-bordered table-striped table-sm" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>Bil</th>
                                            <th>Nama</th>
                                    ...
                                    foreach ($users as $user) {
                                        ...
                                        <tr>
                                            <td>{{ $bil }}</td>
                                            <td>{{ $user->name }}</td>
                                            <td>{{ isset($user->agensiOrganisasi->name) ? $user->agensiOrganisasi->name : '' }}
                                            </td>
                                            <td>
                                                <?php
                                            ...
                                            <td>
                                                <button type="button" data-toggle="modal" data-target="#modal-butiran"
                                                    class="butiran btn btn-sm btn-primary"
                                                    data-userid="{{ $user->id }}"><i class="fas fa-eye mr-2"></i>Butiran</button>
                                            </td>
                                            <td>
                                                <div class="form-inline">
                                                    <button type="button" class="btn btn-sm btn-success btn_lulus mr-2"
                                                        data-userid="{{ $user->id }}"><i
                                                            class="fas fa-check"></i></button>
                                                    <button type="button" class="btn btn-sm btn-danger btn_tolak"
                                                        data-userid="{{ $user->id }}"><i
