                                              ...
                                              <tr>
                                                  <td> 
                                                      <label class="form-check-label" for="c3_4">
                                                        ...
                                                        <input type="text" name="c15_t1_commission_conform_result" id="c15_t1_commission_conform_result" class="form-control" disabled>
                                                      </label>
                                                        </td>
                                                  <td>
                                                     <label class="form-check-label" for="c3_4">
                                                        <b>Conformance Result:</b>
                                                        <input type="text" name="c15_t1_omission_conform_result" id="c15_t1_omission_conform_result" class="form-control" disabled>
                                                      </label>
                                                  </td>
                                              </tr>
                                            </tbody>
