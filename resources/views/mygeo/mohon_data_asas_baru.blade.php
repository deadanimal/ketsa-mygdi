                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-10 pl-lg-5">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-8">
                                            <input class="form-control form-control-sm ml-3" name="nama_penuh" type="text" value="{{ $user->name }}" disabled />
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-3">
                                        ...
                                        <div class="col-8">
                                            <input class="form-control form-control-sm ml-3" name="nric" type="text" value="{{ $user->nric }}" disabled />
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-3">
                                        ...
                                        <div class="col-8">
                                            <input class="form-control form-control-sm ml-3" name="institusi" type="text" value="{{ $user->agensi_organisasi }}" disabled />
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-3">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-3">
                                            <input class="form-control form-control-sm ml-3" name="tel_pejabat" type="text" value="{{ $user->phone_pejabat }}" disabled />
                                        </div>
                                        <div class="col-2">
                                        ...
                                        <div class="col-3">
                                            <input class="form-control form-control-sm ml-3" name="tel_bimbit" type="text" value="{{ $user->phone_bimbit }}" disabled />
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-3">
                                        ...
                                        <div class="col-3">
                                            ...
                                            if (!empty($user->getRoleNames())) {
                                                ...
                                                foreach ($user->getRoleNames() as $role) {
                                                    ?><input class="form-control form-control-sm ml-3" name="peranan" type="text" value="<?php echo $role; ?> " disabled /><?php
                                        ...
                                        <div class="col-3">
                                            <input class="form-control form-control-sm ml-3" name="kategori" type="text" value="{{$user->kategori}}" disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-5 text-right">
                                    ...
                                    <a class="btn btn-sm btn-default" data-toggle="modal" data-target="#modal-senarai-kawasan-data"><span class="text-white">Tambah</span></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-5 text-right">
                                    <a class="btn btn-sm btn-default" data-toggle="modal" data-target="#modal-dokumen-berkaitan"><span class="text-white">Tambah</span></a>
                                </div>
                            </div>
