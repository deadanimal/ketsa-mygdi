                        ...
                        <div  class="card-body py-4 px-">
                            ...
                            <div class="px-2">
                                ...
                                <div class="row pl-lg-2 mb-4">
                                    <div class="col-xl-4">
                                        <div class=" custom-control custom-radio mb-2">
                                            <input [(ngModel)]="checkOther" class=" custom-control-input" id="radioCheck21" name="custom-radio-2" type="radio" value="1" />
                                            <label class=" custom-control-label" for="radioCheck21">
                                                Internet (MyGeo Explorer)
                                            </label>
                                        </div>
                                        <div class=" custom-control custom-radio mb-2">
                                            <input [(ngModel)]="checkOther" class=" custom-control-input" id="radioCheck22" name="custom-radio-2" type="radio" value="2" />
                                    ...
                                    <div class="col-xl-4">
                                        <div class=" custom-control custom-radio mb-2">
                                            <input [(ngModel)]="checkOther" class=" custom-control-input" id="radioCheck23" name="custom-radio-2" type="radio" value="3" />
                                            <label class=" custom-control-label" for="radioCheck23">
                                                Agensi Kerajaan Lain
                                            </label>
                                        </div>
                                        <div class=" custom-control custom-radio mb-2">
                                            <input [(ngModel)]="checkOther" class=" custom-control-input" id="radioCheck24" name="custom-radio-2" type="radio" value="4" />
                            ...
                            <div class="px-2">
                                ...
                                <div class="row">
                                    <div class="col-xl-8">
                                        ...
                                        <div class="row pl-lg-4 mb-4">
                                            <div class="col-xl-3">
                                                <div class="custom-control custom-radio mb-2">
                                                    <input class=" custom-control-input" type="radio" id="choice1" name="yes2"><label class="custom-control-label" for="choice1">
                                                        Ya
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-xl-4">
                                                <div class="custom-control custom-radio">
                                                    <input class=" custom-control-input" type="radio" id="choice2" name="yes2"><label class="custom-control-label" for="choice2">
                                                        Tidak
                                                    </label>
                                                </div>
                                            </div>
                                ...
                                <div [formGroup]="myForm">
                                    <div class="container p-0" style="border: 1px solid lightgray; border-radius: .25rem; min-height: 200px;">
                                        <input formControlName="file" id="file" type="file" class="form-control" accept="image/*" (change)="onFileChange($event)" sytle="border: none;">
                                        <img [src]="imageSrc" *ngIf="imageSrc" style="max-height: 500px; max-width: 900px" class="p-2" alt="...">
                                    </div>
                                </div>
                                ...
                                <textarea class="form-control form-control-sm mb-4" rows="3" type="text" placeholder="Masukkan Komen / Cadangan anda disini ..."></textarea>
                                <hr class="my-2 bg-dark">
