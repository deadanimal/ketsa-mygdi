...
<div _ngcontent-tvu-c497="" class="card2 mt-9 p-6" style="width:100%;background-color: rgba(255, 255, 255, 0.9);">
    <div _ngcontent-tvu-c497="" class="card-body">
        <div _ngcontent-tvu-c497="" class="form-inline justify-content-center">
            <div _ngcontent-tvu-c497="" class="card fancy_card square rounded-circle circleSenaraiDataAsas">
                <div _ngcontent-tvu-c497="" class="card-body pointer" tabindex="0" ng-reflect-router-link="/datalist"><img _ngcontent-tvu-c497="" height="80" src="./afiqadminmygeo_files/metadata.png"></div>
                <span _ngcontent-tvu-c497="" class="text-center mt-2">Senarai</span><span _ngcontent-tvu-c497="" class="text-center">Data-data Asas</span>
            </div>
            <div _ngcontent-tvu-c497="" class="card fancy_card square rounded-circle mr-9 ml-9 circleTatacaraMohon">
                <div _ngcontent-tvu-c497="" class="card-body pointer" tabindex="0" ng-reflect-router-link="/data-asas"><img _ngcontent-tvu-c497="" height="80" src="./afiqadminmygeo_files/dataapp.png"></div>
                <span _ngcontent-tvu-c497="" class="text-center mt-2">Tatacara Permohonan</span>
            </div>
            <div _ngcontent-tvu-c497="" class="card fancy_card square rounded-circle circleDokumenBerkaitan">
                <div _ngcontent-tvu-c497="" class="card-body pointer" tabindex="0" ng-reflect-router-link="/tutorial"><img _ngcontent-tvu-c497="" height="80" src="./afiqadminmygeo_files/tutorial.png"></div>
                <span _ngcontent-tvu-c497="" class="text-center mt-2">Dokumen Berkaitan</span>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        $(document).on("click",".circleSenaraiDataAsas",function(){
            window.location.href = "{{url('data_asas_senarai')}}";
        });
        $(document).on("click",".circleTatacaraMohon",function(){
            window.location.href = "{{url('data_asas_tatacara_mohon')}}";
        });
        $(document).on("click",".circleDokumenBerkaitan",function(){
            window.location.href = "{{url('data_asas_dokumen_berkaitan')}}";
        });
    });
</script>
@stop
