                          ...
                          <div class="form-group row">
                            ...
                            <table style="width:100%;">
                                <tr>
                                    <td>File Name:</td>
                                    <td>
                                        <input type="text" name="c10_file_name" id="c10_file_name" class="form-control col-lg-4" disabled>
                                    </td>
                                </tr>
                                <tr>
                                    <td>File Name:</td>
                                    <td>
                                        <input type="text" name="c10_file_type" id="c10_file_type" class="form-control col-lg-4" disabled>
                                    </td>
                                </tr>
                                <tr>
                                    <td>URL:</td>
                                    <td>
                                        <input type="text" name="c10_file_url" id="c10_file_url" class="form-control col-lg-4" disabled>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <div class="form-group row">
                            ...
                            <table style="width:100%;">
                                <tr>
                                    <td>Keyword:</td>
                                    <td>
                                        <input type="text" name="c10_keyword" id="c10_keyword" class="form-control col-lg-4" disabled>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Additional Keyword:</td>
                                    <td>
                                        <input type="text" name="c10_additional_keyword[]" class="form-control col-lg-4" disabled>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Additional Keyword:</td>
                    ...
                    <div class="card card-primary div_c11" id="div_c11">
                      ...
                      <div id="collapse11" class="panel-collapse collapse in show" data-parent="#div_c11">
                        <div class="card-body">
                          <div class="form-group row">
                            Distribution Format:
                            <input type="text" name="c11_dist_format" id="c11_dist_format" class="form-control col-lg-2" disabled> 
                            &nbsp;&nbsp;&nbsp;
                            Version:
                            <input type="text" name="c11_version" id="c11_version" class="form-control col-lg-2" disabled> 
                            &nbsp;&nbsp;&nbsp;
                            Medium:
                            <?php
                            ...
                            ?>
                            <input type="text" name="c11_medium" id="c11_medium" class="form-control col-lg-3" value="{{ $medium }}" disabled>
                          </div>
                          <div class="form-group row">
                            Distributor:
                            <input type="text" name="c11_distributor" id="c11_distributor" class="form-control col-lg-4" disabled> 
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <input type="text" name="c11_units_of_dist" id="c11_units_of_dist" class="form-control col-lg-2" value="{{ $unit_distribute }}" disabled> 
                            &nbsp;&nbsp;&nbsp;
                            <?php
                            ...
                            ?>
                            Size (Megabytes):
                            <input type="text" name="c11_size" id="c11_size" class="form-control col-lg-2" value="{{ $size }}" disabled> 
                            &nbsp;&nbsp;&nbsp;
                            Fees:
                            <input type="text" name="c11_fees" id="c11_fees" class="form-control col-lg-2" placeholder="RM 0.00" disabled> 
                          </div>
                          <div class="form-group row">
                            <?php
                            ...
                            ?>
                            Link:
                            <input type="text" name="c11_link" id="c11_link" class="form-control col-lg-3" disabled> 
                            &nbsp;&nbsp;&nbsp;
                            <?php
                            ...
                            <input type="text" name="c11_order_instructions" id="c11_order_instructions" class="form-control col-lg-5" value="{{ $order_instruct }}" disabled> 
                    ...
                    <div class="card card-primary div_c12" id="div_c12">
                      ...
                      <div id="collapse12" class="panel-collapse collapse in show" data-parent="#div_c12">
                        <div class="card-body">
                          <div class="form-group row">
                            Data Set Type:
                            <select name="c12_dataset_type" id="c12_dataset_type" class="form-control col-lg-2" disabled> 
                          ...
                          <div class="form-group row">
                            <div class="col-lg-4">
                              ...
                              <input type="text" name="c12_feature_scale" id="c12_feature_scale" class="form-control col-lg-7" placeholder="10:50000" disabled> 
                              &nbsp;&nbsp;&nbsp;
                            </div>
                            <div class="col-lg-4">
                              Image Resolution (GSD):
                              <div class="input-group mb-3">
                                <input type="text" class="form-control col-lg-5" name="c12_image_res" id="c12_image_res" placeholder="10.5" disabled>
                            ...
                            <div class="col-lg-4">
                              Language:
                              <select name="c12_language" id="c12_language" class="form-control col-lg-7" disabled> 
                      ...
                      <div id="collapse13" class="panel-collapse collapse in show" data-parent="#div_c13">
                        <div class="card-body">
                          <div class="form-group row">
                            ...
                            <select name="c13_ref_sys_identify" id="c13_ref_sys_identify" class="form-control col-lg-2" disabled> 
                          ...
                          <div class="form-group row">
                            <div class="d-flex flex-wrap bd-highlight">
                              <div class="p-8 bd-highlight">
                                <div class="form-check">
                                  <label class="form-check-label" for="c3_1"><b>Projection:</b> Cassini-Soldner</label>
                                </div>
                              </div>
                              <div class="p-8 bd-highlight">
                                <div class="form-check">
                                  <label class="form-check-label" for="c3_2"><b>Semi Major Axis:</b> 6337304.0630000001</label>
                                </div>
                              </div>
                              <div class="p-8 bd-highlight">
                                <div class="form-check">
                                  <label class="form-check-label" for="c3_3"><b>Ellipsoid:</b> Modified Everest</label>
                                </div>
                              </div>
                              <div class="p-8 bd-highlight">
                                <div class="form-check">
                                  <label class="form-check-label" for="c3_4"><b>Axis Units:</b> Meter</label>
                                </div>
                              </div>
                              <div class="p-8 bd-highlight">
                                <div class="form-check">
                                  <label class="form-check-label" for="c3_5"><b>Datum:</b> Kertau 1948</label>
                                </div>
                              </div>
                              <div class="p-8 bd-highlight">
                                <div class="form-check">
                                  <label class="form-check-label" for="c3_6"><b>Denominator of Flattening Ratio:</b> 300.801699999999980</label>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <table class="table-borderless" style="width: 100%">
                              ...
                              <tbody>
                                <tr>
                                  <td>
                                    Access Constraints:
                                    <select name="c14_access_constraint" id="c14_access_constraint" class="form-control col-lg-7" disabled>
                                  ...
                                  <td>
                                    ...
                                    <select name="c14_classification_sys" id="c14_classification_sys" class="form-control col-lg-4" disabled> 
                                ...
                                <tr>
                                  <td>
                                    Use Constraints:
                                    <select name="c14_use_constraint" id="c14_use_constraint" class="form-control col-lg-7" disabled>
                                      <option value="copyright">Copyright</option>
                                      <option value="intelect_prop_right">Intellectual Property Rights</option>
                                      <option value="license">License</option>
                                      <option value="license_end_user">License End User</option>
                                  ...
                                  <td>
                                    Reference:
                                    <input type="text" name="c14_reference" id="c14_reference" class="form-control col-lg-9" placeholder="Standard/Policy/Act/Circular/Legal" disabled>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                    ...
                    <div class="card card-primary div_c15" id="div_c15">
                      ...
                      <div id="collapse15" class="panel-collapse collapse in show" data-parent="#div_c15">
                        <div class="card-body">
                          ...
                          <div class="form-group row">
                            DQ Scope:
                            <select name="c15_data_quality_info" id="c15_data_quality_info" class="form-control col-lg-3" disabled> 
                            ...
                            &nbsp;&nbsp;&nbsp;
                            Data History:
                            <input type="text" name="c15_data_history" id="c15_data_history" class="form-control col-lg-2" disabled>
                            &nbsp;&nbsp;&nbsp;
                            <div class="form-group">
                              <label>Date:</label>
                              <div class="input-group date" id="c15_date_div" data-target-input="nearest">
                                  <input type="text" name="c15_date" id="c15_date" class="form-control datetimepicker-input" data-target="#c15_date_div" disabled>
