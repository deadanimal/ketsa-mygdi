...
<div class="" style="width:100%;">
    <section class="content">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="card p-3 " style="background-color: rgba(255, 255, 255, 0.9);">
                        <div class="card-body text-center">
                            ...
                            <form method="post" class="navbar-search navbar-search-light form-inline my-4 justify-content-center" action="{{url('carian_metadata_nologin')}}" id="form_carian">
                                ...
                                <div class="form-inline mb-0">
                                    <div class="input-group input-group-alternative input-group-merge" style="background-image: linear-gradient(to right, #ebba16, #ed8a19);">
                                        ...
                                        <input placeholder="Carian..." type="text" name="carian" id="carian" class="form-control">
                                    </div>
                                </div>
                            ...
                            <a class="btn btn-sm btn-primary text-white text-center" data-toggle="modal" data-target="#modal-carian-tabahan" style="cursor:pointer;">
                                Carian Tambahan &gt;&gt;
                            </a>
                        </div>
                    </div>
...
<?php
if (count($metadatas) > 0) {
    ?>$(".divSenaraiMetadata").show();<?php
} else {
    ?>$(".divSenaraiMetadata").hide();<?php
}
?>
