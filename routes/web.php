...
Route::get('/lihat_xml_nologin', 'MetadataController@show_xml_nologin');
Route::get('/apilist', 'MetadataController@apilist');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/simpan_senarai_kawasan', [DataAsasController::class, 'store_senarai_kawasan']);
    ...
    Route::get('/akuan_penerimaan/{id}/{url_id}', 'DataAsasController@akuan_terima');
    ...
    Route::post('/select_jenis_data', [DataAsasController::class, 'select_jenis_data']);
