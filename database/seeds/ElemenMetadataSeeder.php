...
class ElemenMetadataSeeder extends Seeder
{
    ...
    public function run()
    {
        for($r=1;$r<5;$r++){ //seed for each kategori 1-4
            ...
            //Topic Category
            ElemenMetadata::create(["label"=>"Administrative and Political Boundaries","tajuk"=>"3","input_name"=>"topic_category[]","status"=>"1","kategori"=>$r]);
            ...
            ElemenMetadata::create(["label"=>"Environment and Conservation","tajuk"=>"3","input_name"=>"topic_category[]","status"=>"1","kategori"=>$r]);
            ElemenMetadata::create(["label"=>"Facilities and Structures","tajuk"=>"3","input_name"=>"topic_category[]","status"=>"1","kategori"=>$r]);
            ElemenMetadata::create(["label"=>"Geological and Geophysical","tajuk"=>"3","input_name"=>"topic_category[]","status"=>"1","kategori"=>$r]);
            ElemenMetadata::create(["label"=>"Human Health and Disease","tajuk"=>"3","input_name"=>"topic_category[]","status"=>"1","kategori"=>$r]);
            ElemenMetadata::create(["label"=>"Imagery and Base Maps","tajuk"=>"3","input_name"=>"topic_category[]","status"=>"1","kategori"=>$r]);
            ElemenMetadata::create(["label"=>"Inland Water Resources","tajuk"=>"3","input_name"=>"topic_category[]","status"=>"1","kategori"=>$r]);
            ElemenMetadata::create(["label"=>"Locations and Geodetic Networks","tajuk"=>"3","input_name"=>"topic_category[]","status"=>"1","kategori"=>$r]);
            ElemenMetadata::create(["label"=>"Military","tajuk"=>"3","input_name"=>"topic_category[]","status"=>"1","kategori"=>$r]);
            ElemenMetadata::create(["label"=>"Oceans and Estuaries","tajuk"=>"3","input_name"=>"topic_category[]","status"=>"1","kategori"=>$r]);
            ElemenMetadata::create(["label"=>"Transportation Networks","tajuk"=>"3","input_name"=>"topic_category[]","status"=>"1","kategori"=>$r]);
            ElemenMetadata::create(["label"=>"Utilities and Communication","tajuk"=>"3","input_name"=>"topic_category[]","status"=>"1","kategori"=>$r]);
            //Nominal Resolution
