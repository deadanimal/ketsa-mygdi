...
class CreateLapisanSenaraiDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lapisan_senarai_data', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('lapisan_senarai_data');
    }
}
